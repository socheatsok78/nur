...
stdenv.mkDerivation (finalAttrs: {
  ...
  cmakeFlags = [
    ...
    (lib.cmakeBool "OPT_BUILD_BADGESDR_SOURCE" false)
    ...
    (lib.cmakeBool "OPT_BUILD_FOBOSSDR_SOURCE" false)
    (lib.cmakeBool "OPT_BUILD_HACKRF_SOURCE" hackrf_source)
    (lib.cmakeBool "OPT_BUILD_HAROGIC_SOURCE" false)
    (lib.cmakeBool "OPT_BUILD_HERMES_SOURCE" hermes_source)
    (lib.cmakeBool "OPT_BUILD_HYDRASDR_SOURCE" false)
    (lib.cmakeBool "OPT_BUILD_KCSDR_SOURCE" false)
    ...
    (lib.cmakeBool "OPT_BUILD_RFNM_SOURCE" false)
    ...
    (lib.cmakeBool "OPT_BUILD_SPECTRAN_SOURCE" false)
    ...
    (lib.cmakeBool "OPT_BUILD_HL2_SOURCE" true)
    (lib.cmakeBool "OPT_BUILD_USRP_SOURCE" usrp_source)
    (lib.cmakeBool "OPT_BUILD_KIWISDR_SOURCE" true)

    # Sinks
    (lib.cmakeBool "OPT_BUILD_ANDROID_AUDIO_SINK" false)
    (lib.cmakeBool "OPT_BUILD_AUDIO_SINK" audio_sink)
    (lib.cmakeBool "OPT_BUILD_NETWORK_SINK" network_sink)
    (lib.cmakeBool "OPT_BUILD_MPEG_ADTS_SINK" false)
    (lib.cmakeBool "OPT_BUILD_NEW_PORTAUDIO_SINK" portaudio_sink)
    (lib.cmakeBool "OPT_BUILD_PORTAUDIO_SINK" false)
    ...
    (lib.cmakeBool "OPT_BUILD_CH_EXTRAVHF_DECODER" false)
    (lib.cmakeBool "OPT_BUILD_CH_TETRA_DEMODULATOR" false)
    (lib.cmakeBool "OPT_BUILD_FT8_DECODER" false)
    (lib.cmakeBool "OPT_BUILD_DSDCC_DECODER" false)
    ...
    (lib.cmakeBool "OPT_BUILD_RYFI_DECODER" false)
    ...
    (lib.cmakeBool "OPT_BUILD_TCI_SERVER" true)
    (lib.cmakeBool "OPT_BUILD_SCANNER" scanner)
    (lib.cmakeBool "OPT_BUILD_SCHEDULER" false)
    (lib.cmakeBool "OPT_BUILD_NOISE_REDUCTION_LOGMMSE" true)
